...
-- 认真就输、QQ:7343696
-- http://www.htz.pw
-- 2018.01.11 初始版本，主要用于ash_total.sql结果运行后，使用ash_object_by_waitclass.sql来定位更详细的信息
...
ACCEPT waitclass prompt 'Enter Search Wait Class  (i.e. User I/O(default)) : ' default 'User I/O'
